...
class LeaguesControllerTest < ActionController::TestCase
  ...
  test "should create league" do
    assert_difference('League.count') do
      post :create, league: { creator: @league.creator, name: @league.name, private: @league.private, start_week: @league.start_week }
    end
  ...
  test "should update league" do
    patch :update, id: @league, league: { creator: @league.creator, name: @league.name, private: @league.private, start_week: @league.start_week }
    assert_redirected_to league_path(assigns(:league))
  end
